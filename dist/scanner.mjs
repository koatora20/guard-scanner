...
import { scoreWithRust } from "./rust-bridge.js";
const VERSION = CAPABILITIES.product.version;
...
\u{1F6E1}\uFE0F  guard-scanner v${VERSION}`);
  ...
  scanTarget(targetPath, targetName, kind) {
    ...
    if (kind === "skill" && KNOWN_MALICIOUS.typosquats.includes(targetName.toLowerCase())) {
      findings.push({
        severity: "CRITICAL",
        id: "KNOWN_TYPOSQUAT",
        cat: "malicious-code",
  ...
  scoreFindings(findings) {
    const rust = scoreWithRust(findings);
    if (rust) {
