...
function smokeInstall(tarballPath, pkgName) {
  const tempDir = (0, import_node_fs.mkdtempSync)((0, import_node_path.join)((0, import_node_os.tmpdir)(), "guard-scanner-pack-"));
  try {
    (0, import_node_fs.writeFileSync)(
      (0, import_node_path.join)(tempDir, "package.json"),
...
function main() {
  ...
  const pkg = loadJson((0, import_node_path.join)(root, "package.json"));
  const manifest = loadJson((0, import_node_path.join)(root, "openclaw.plugin.json"));
  const capabilities = loadJson((0, import_node_path.join)(root, "docs", "spec", "capabilities.json"));
  const compatibility = loadJson((0, import_node_path.join)(root, "docs", "compatibility.json"));
  const readme = (0, import_node_fs.readFileSync)((0, import_node_path.join)(root, "README.md"), "utf8");
  const skill = (0, import_node_fs.readFileSync)((0, import_node_path.join)(root, "SKILL.md"), "utf8");
  const wrapperSkill = (0, import_node_fs.readFileSync)((0, import_node_path.join)(root, "clawhub", "guard-scanner-thin-wrapper", "SKILL.md"), "utf8");
  const wrapperReadme = (0, import_node_fs.readFileSync)((0, import_node_path.join)(root, "clawhub", "guard-scanner-thin-wrapper", "README.md"), "utf8");
  ...
  assert((0, import_node_fs.existsSync)((0, import_node_path.join)(root, "README.md")), "missing README.md");
  assert((0, import_node_fs.existsSync)((0, import_node_path.join)(root, "LICENSE")), "missing LICENSE");
  assert((0, import_node_fs.existsSync)((0, import_node_path.join)(root, "SKILL.md")), "missing SKILL.md");
  assert((0, import_node_fs.existsSync)((0, import_node_path.join)(root, "SECURITY.md")), "missing SECURITY.md");
  assert((0, import_node_fs.existsSync)((0, import_node_path.join)(root, "docs", "public-safe-boundary.md")), "missing public-safe boundary doc");
  assert((0, import_node_fs.existsSync)((0, import_node_path.join)(root, "docs", "spec", "capabilities.json")), "missing capabilities source of truth");
  assert((0, import_node_fs.existsSync)((0, import_node_path.join)(root, "clawhub", "guard-scanner-thin-wrapper", "SKILL.md")), "missing ClawHub thin wrapper skill");
  assert((0, import_node_fs.existsSync)((0, import_node_path.join)(root, "clawhub", "guard-scanner-thin-wrapper", "README.md")), "missing ClawHub thin wrapper README");
  ...
  const packDir = (0, import_node_fs.mkdtempSync)((0, import_node_path.join)((0, import_node_os.tmpdir)(), "guard-scanner-pack-gate-"));
  ...
  const tarballPath = (0, import_node_path.join)(packDir, tarballName);
  ...
  try {
    ...
    (0, import_node_fs.rmSync)(tarballPath, { force: true });
    (0, import_node_fs.rmSync)(packDir, { recursive: true, force: true });
  }
  const ossReport = JSON.parse(run("node", [(0, import_node_path.join)(root, "dist", "tools", "oss-release-report.js")], root));
