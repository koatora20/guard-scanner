...
exports.PATTERNS = [
    ...
    { id: 'PII_MY_NUMBER', cat: 'pii-exposure', regex: /(?:my[_\s-]*number|マイナンバー|個人番号|住民票|番号)\s*[:=]?\s*\d{4}[\s-]?\d{4}[\s-]?\d{4}/gi, severity: 'CRITICAL', desc: 'Potential My Number (個人番号)', all: true, owasp: 'LLM02' },
