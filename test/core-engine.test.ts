...
const { RuleRegistry } = require('../src/core/rule-registry');
const { calculateRisk, detectAttackChainId } = require('../src/core/risk-engine');
const { applySemanticValidators } = require('../src/core/semantic-validators');
