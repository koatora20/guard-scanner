...
| **26ランタイムチェック** | リアルタイム `before_tool_call` フック — 5層防御 (v3.4.0) |
...
> **v3.4.0** — ランタイムガードがスタンドアロンJSモジュール (`src/runtime-guard.js`) + OpenClawプラグイン (`hooks/guard-scanner/plugin.ts`) として利用可能。
